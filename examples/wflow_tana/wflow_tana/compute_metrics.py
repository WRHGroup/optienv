...
# ---------- Built-in station mapping (obs_name -> sim column) ----------
# Updated per your request: handle multiple stations without adding arguments.
BUILTIN_STATION_MAP = {
    "Gilgel Abay":  "Q_1001",
    "Gumera": "Q_1002",
    "Rib":    "Q_1003",
...
def main():
    ...
    # Per-station metrics (equal-weight aggregation)
